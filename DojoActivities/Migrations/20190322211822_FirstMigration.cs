            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActivId = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ActivOne = table.Column<string>(nullable: false),
                    ActivTwo = table.Column<string>(nullable: false),
                    ActivDate = table.Column<DateTime>(nullable: false),
                    ...
                    DuratUnit = table.Column<string>(nullable: false),
                    UserId = table.Column<int>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    UpdatedAt = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Activs", x => x.ActivId);
                    table.ForeignKey(
